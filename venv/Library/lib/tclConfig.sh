...
# installed.
TCL_PREFIX='D:/SureshKrishna/CompleteDS/Projects-EndToEnd/CompleteML-lifecycle/mlflow-ml-lifecycle/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/SureshKrishna/CompleteDS/Projects-EndToEnd/CompleteML-lifecycle/mlflow-ml-lifecycle/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/SureshKrishna/CompleteDS/Projects-EndToEnd/CompleteML-lifecycle/mlflow-ml-lifecycle/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/SureshKrishna/CompleteDS/Projects-EndToEnd/CompleteML-lifecycle/mlflow-ml-lifecycle/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/SureshKrishna/CompleteDS/Projects-EndToEnd/CompleteML-lifecycle/mlflow-ml-lifecycle/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/SureshKrishna/CompleteDS/Projects-EndToEnd/CompleteML-lifecycle/mlflow-ml-lifecycle/venv\Library\lib\tclstub86.lib'
